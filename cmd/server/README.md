...
![](../../docs/images/go-marc-server-v3.png)
...
The `/` (or default) endpoint will display a handy web interface for converting MARC 034 records in to bounding boxes. _This is every screenshot you've seen so far._
